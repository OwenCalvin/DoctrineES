...
// Créer une fonctionnalité de création de hashtag
// Les données permettant de mettre à jour le hashtag (l'id et texte) sont passées en get ($_GET) (ou POST, comme vous voulez)
